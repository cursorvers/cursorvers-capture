  ...
  render(): ReactNode {
    ...
    return (
      <main className="mx-auto flex min-h-screen max-w-md flex-col items-center justify-center gap-6 px-5 py-12 text-ink-100">
        ...
        <details className="w-full rounded-2xl border border-hairline bg-ink-900/40 px-4 py-3 text-[11px] text-ink-300">
        ...
        <div className="flex w-full flex-col gap-2">
          <button
            ...
            className="inline-flex h-11 w-full items-center justify-center rounded-2xl bg-accent px-5 text-[14px] font-medium text-white shadow-glow transition active:scale-[0.98] hover:bg-accent/90"
          >
            🔄 再読込
          </button>
          <button
            ...
            className="inline-flex h-10 w-full items-center justify-center rounded-2xl border border-hairline bg-ink-900/70 px-5 text-[12px] text-ink-300 hover:border-white/15 hover:bg-ink-900"
          >
            🧹 キャッシュごとリセット + 再読込
          </button>
        </div>
