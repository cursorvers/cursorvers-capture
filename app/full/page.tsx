export default function FullPage() {
  return (
    <div className="mx-auto flex min-h-[calc(100vh-9rem)] max-w-md flex-col items-center justify-center gap-6 px-5 py-12 text-center">
      <span className="inline-flex items-center gap-1.5 rounded-full border border-amber-500/40 bg-amber-500/10 px-3 py-1 text-[10px] uppercase tracking-[0.18em] text-amber-200">
        Capacity reached
      </span>
