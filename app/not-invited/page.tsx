...
export default function NotInvitedPage() {
  return (
    <div className="mx-auto flex min-h-[calc(100vh-9rem)] max-w-md flex-col items-center justify-center gap-6 px-5 py-12 text-center">
      <span className="inline-flex items-center gap-1.5 rounded-full border border-hairline bg-white/[0.02] px-3 py-1 text-[0.625rem] uppercase tracking-[0.18em] text-ink-300">
        Restricted
      </span>
      ...
      <Link
        ...
        className="inline-flex h-10 items-center gap-2 rounded-full border border-hairline bg-ink-800/60 px-4 text-[0.8125rem] font-medium text-ink-100 transition hover:border-white/20 hover:bg-ink-800"
      >
        info@cursorvers.com
      </Link>
    </div>
