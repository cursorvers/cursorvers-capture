...
| Cursorvers (Masa) を経路から外したい | **可能**。[docs/SELF_HOST.md](docs/SELF_HOST.md) に沿って 30-60 分で独立インスタンス構築、データ・認証・AI 課金すべて自社で運用 |
...
5. **[Self-host (Cursorvers を経路から外す)](docs/SELF_HOST.md)** ← 配布先パートナー向け
6. [技術スタック](#技術スタック)
7. [OAuth スコープと「できる/できない」](#oauth-スコープとできるできない)
8. [ローカル開発](#ローカル開発)
9. [デプロイ](#デプロイ)
9. [環境変数](#環境変数)
